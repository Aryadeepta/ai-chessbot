...
class Bot:
    ...
    def __init__(self):
        self.piece_values = {' ' : 0,'P': 1, 'N': 3, 'B': 3, 'R': 5,
                             'S': 5, 'Q': 9, 'J': 9, 'K': 100}
        self.center_bonus = {(1,2) : 0.25, (1,3):0.25, (2, 2): 0.5, (2, 3): 0.5,
                             (3, 2): 0.5, (3, 3): 0.5, (4,2) : 0.25, (4,3):0.25}
        self.check_penalty = -10000
    ...
    def evaluate_move(self, side, board, move):
        ...
        if self.is_in_check(side, board):
            ...
            score = material_gain * 35 + pos_bonus + board_eval * 0.8
